      ...
      <div className="pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-6">
            <p>
              Immer mehr Betriebe gehen heute dazu über, die Gesundheit ihrer Angestellten zu
              fördern.
            </p>
            <p>
              Shiatsu auf dem Stuhl ist hervorragend dafür geeignet, krankmachenden Stress abzubauen
              und Verspannungen zu lösen. Es lässt sich problemlos in jeden Betriebsablauf
              integrieren &ndash; kein Umziehen, kein Ausziehen, einfach Platz nehmen und die
              wohltuende Akupressur genießen. Danach fühlt man sich erfrischt und entspannt.
            </p>
            <p>
              Der Shiatsu-Stuhl ist besonders bequem und wird mitgebracht. Gerne vereinbare ich mit
              Ihnen einen{' '}
              <a
                href="/kontakt"
