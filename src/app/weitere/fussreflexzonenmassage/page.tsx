      ...
      <div className="pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-6">
            <p>
              Die Reflexzonenmassage ist eine Druckmassage, die schon bei alten Völkern wie z.B. bei
              einigen Indianerstämmen bekannt war und zur Schmerzlinderung erfolgreich eingesetzt
              wurde. Im 20. Jahrhundert entdeckte dann der HNO-Arzt Dr. Fitzgerald, dass durch
              Druckmassage in bestimmten Regionen an Händen und Füßen in den zugeordneten Organen
              die Schmerzen nachlassen oder sogar verschwinden.
            </p>

            <p>
              Hanne Marquardt hat in den 70er Jahren die Fußreflexzonentherapie hier bei uns in
              Europa bekannt gemacht und gilt als richtungsweisend in diesem Bereich. Dabei geht es
              nicht nur um Schmerzlinderung, sondern auch um Verbesserung von Beschwerden
              unterschiedlicher Art wie z.B. Migräne, Verdauungsprobleme, Schwindel etc.
            </p>

            <p>
              Aber nicht nur für die Gesundheit, sondern auch für das allgemeine Wohlbefinden kann
              die Fußreflexzonenmassage einen guten Beitrag leisten. Viele berichten, dass sie sich
              hinterher sehr entspannt und gelöst fühlten.
            </p>
          </div>
        </div>
      </div>
