          ...
          <div className="text-lg text-gray-700 leading-relaxed">
            ...
            <blockquote className="relative border-l-4 border-primary/30 pl-6 py-4 mb-10 bg-surface-light rounded-r-xl">
              ...
              <p className="italic text-gray-600">
                &bdquo;Es ist vielleicht die größte Lektion des Lebens, Freiheit zu lernen. Freiheit
                von den äußeren Umständen, von der Umgebung, anderen Persönlichkeiten und vor allen
                Dingen von uns selbst, denn solange wir nicht frei sind, sind wir nicht in der Lage,
                uns ganz zu verschenken und unseren Mitmenschen zu dienen.&ldquo;
              </p>
            ...
            <div className="flex gap-4 items-start mb-6">
              ...
              <p>
                Dem Arzt Dr. Edward Bach war sehr daran gelegen, eine naturheilkundliche
                Therapieform zu entwickeln, die den Menschen wieder mit den Bedürfnissen seiner
                Seele in Verbindung bringt. Er entwickelte 38 Blütenessenzen, die den archetypischen
                Gemütszuständen eines Menschen entsprechen, egal, in welcher Zeit und an welchem Ort
                er lebt und die einen Impuls zur positiven Veränderung geben.
              </p>
            </div>
          </div>
        </div>
