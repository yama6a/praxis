...
import { MdSelfImprovement, MdSpa, MdCardGiftcard, MdLocalFlorist } from 'react-icons/md';
        ...
        {entries.map((entry) => (
          <div key={entry.label} className="flex items-baseline justify-between gap-4">
            <div className="min-w-0">
              ...
              {entry.detail && (
                <span className="block text-sm text-muted-foreground">{entry.detail}</span>
              )}
            </div>
            <span className="text-primary font-bold text-lg whitespace-nowrap">{entry.price}</span>
          </div>
        ))}
      </div>
    ...
    <>
      ...
      <div className="pt-28 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-display font-bold text-primary mb-2">Preise</h1>
          ...
          <div className="mt-8 bg-white rounded-2xl shadow-sm border border-border overflow-hidden sm:flex">
            ...
            <div className="p-6 sm:p-8 sm:w-3/5">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Schenken Sie Ihren Freunden und Bekannten eine entspannende Shiatsu-Anwendung!
              </p>

              <div className="flex items-baseline justify-between gap-4 mb-4">
                <div>
                  <span className="text-gray-900 font-medium">Shiatsu-Anwendung</span>
                  <span className="block text-sm text-muted-foreground">60 Minuten</span>
                </div>
                <span className="text-primary font-bold text-lg whitespace-nowrap">85 €</span>
              </div>

              <div className="border-t border-border pt-4 space-y-2 text-sm text-muted-foreground leading-relaxed">
                <p>Die Anwendung beinhaltet ein kurzes Vor- und Nachgespräch.</p>
                <p>
