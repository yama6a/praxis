...
import { MdLocalPharmacy, MdSelfImprovement, MdSpa, MdHealthAndSafety } from 'react-icons/md';
  ...
  return (
    <div className="pt-28 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-display font-bold text-primary mb-10">Qualifikationen</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">Apothekerin</h2>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">Heilpraktikerin</h2>
              </div>
              <ul className="list-disc text-gray-700 space-y-1 ml-9">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-display font-bold text-gray-900">Yogalehrerin</h2>
            </div>
            <div className="flex gap-6">
              <ul className="list-disc text-gray-700 space-y-1 ml-9 flex-1">
                <li>Für Erwachsene und Kinder seit 1994</li>
                <li>Mehrjährige Ausbildung bei Asha Rekai nach Dr. Swami Gitananda Giri</li>
                <li>
                  Unterricht in verschiedenen Stilen, z.B. nach Iyengar bei Andreas Riester und
                  Shivananda-Yoga
                </li>
                <li>Weiterbildung zur Yogatherapeutin bei Dr. Günter Niessen</li>
              </ul>
              <Image
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-xl font-display font-bold text-gray-900">Shiatsu</h2>
            </div>
            <ul className="list-disc text-gray-700 space-y-1 ml-9">
              <li>Ausgebildete Shiatsu-Therapeutin seit 1997</li>
              <li>
                Shiatsu-Dozentin beim Verband für Physiotherapie und verschiedenen Schulen für
                Krankengymnastik
              </li>
              <li>Fortbildungen u.a. bei Rappenecker, Peter Itin und weiteren Lehrern</li>
            </ul>
          </div>
        </div>
      </div>
