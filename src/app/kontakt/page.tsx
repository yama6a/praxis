    ...
    <>
      ...
      <div className="pt-28 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-display font-bold text-primary mb-10">Kontakt & Anfahrt</h1>
          ...
          <div className="mb-6">
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">Adresse</h2>
              </div>
          ...
          <div className="mb-6">
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">Nachricht senden</h2>
              </div>
              <form
              ...
              >
                <input
                  type="hidden"
                  name="_subject"
                  value="Neue Kontaktanfrage – Praxis Körpertherapie"
                />
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Durch die Nutzung dieses Kontaktformulars werden Ihre durch Sie mitgeteilten
                  Daten, Ihre E-Mail Adresse sowie Ihre IP-Adresse an mich übermittelt und für
                  weitere Kontaktaufnahmen gespeichert.
                </p>
                <button
                  type="submit"
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-6">
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">U-Bahn & S-Bahn</h2>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-border p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-display font-bold text-gray-900">Bus</h2>
              </div>
              <ul className="text-gray-700 space-y-1 ml-9">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-border p-6 mb-6">
            ...
            <ul className="list-disc text-gray-700 space-y-2 ml-9">
              <li>
                Über die A100 Abfahrt Knobelsdorffstraße, Richtung Osten bis Ecke Danckelmannstraße.
              </li>
              <li>
                Über Otto-Suhr-Allee / Spandauer Damm am Klausener Platz Richtung Süden abbiegen in
                die Danckelmannstr. bis zur Ecke Knobelsdorffstr.
              </li>
              <li>
                Über die Bismarckstraße, an der Ecke Danckelmannstraße Richtung Norden abbiegen und
                bis zur Ecke Knobelsdorffstraße.
              </li>
              <li>
                Über die Bismarckstraße, an der Ecke Schlossstraße Richtung Norden abbiegen und an
                der zweiten Ecke links in die Knobelsdorffstraße einbiegen.
              </li>
            </ul>
          </div>
