...
type RedirectEntry = { oldPath: string; target: string } | { oldPath: string; gone: true };
...
const entries: RedirectEntry[] = [
  ...
  {
    oldPath: '/wp/category/weitere-angebote/bach-blutentherapie',
    target: '/weitere/bach-bluetentherapie/',
  },
  {
    oldPath: '/wp/category/weitere-angebote/fusreflexzonenmassage',
    target: '/weitere/fussreflexzonenmassage/',
  },
